...
export type ActionProfileType = AddPostAction |  setUserProfileAction | setStatusAction | DeletePostAction
...
export const deletePost = (postId: number): DeletePostAction => ({type: DELETE_POST, postId})
